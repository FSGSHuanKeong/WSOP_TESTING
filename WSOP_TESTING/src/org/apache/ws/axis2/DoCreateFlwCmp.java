 ...
 */
            ...
            /**
            *  DoCreateFlwCmp bean class
            */
        
        public  class DoCreateFlwCmp
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localCatCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCatCodeTracker = false ;
                           ...
                           */
                           public  java.lang.String getCatCode(){
                            ...
                            /**
                               ...
                               * @param param CatCode
                               */
                               public void setCatCode(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localCatCodeTracker = true;
                                       } else {
                                          localCatCodeTracker = true;
                                              
                                       }
                                   
                                            this.localCatCode=param;
                        ...
                        */
                                    ...
                                    protected java.lang.String localFlwMcod ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localFlwMcodTracker = false ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getFlwMcod(){
                               return localFlwMcod;
                           }
                            ...
                            /**
                               ...
                               * @param param FlwMcod
                               */
                               public void setFlwMcod(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localFlwMcodTracker = true;
                                       } else {
                                          localFlwMcodTracker = true;
                                              
                                       }
                                   
                                            this.localFlwMcod=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DoCreateFlwCmp.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":doCreateFlwCmp",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "doCreateFlwCmp",
                ...
                if (localAutInfoTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"catCode", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"catCode");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("catCode");
                                    }
                                

                                          if (localCatCode==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localCatCode);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localFlwMcodTracker){
                                    namespace = "http://ws.apache.org/axis2";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"flwMcod", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"flwMcod");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("flwMcod");
                                    }
                                

                                          if (localFlwMcod==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localFlwMcod);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                    ...
                                    localLogKey);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                         ...
                                         elementList.add(localCatCode==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCatCode));
                                    } if (localFlwMcodTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                                                      "flwMcod"));
                                 
                                         elementList.add(localFlwMcod==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFlwMcod));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static DoCreateFlwCmp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DoCreateFlwCmp object =
                new DoCreateFlwCmp();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"doCreateFlwCmp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DoCreateFlwCmp)org.apache.ws.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.apache.org/axis2","catCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.apache.org/axis2","flwMcod").equals(reader.getName())){
