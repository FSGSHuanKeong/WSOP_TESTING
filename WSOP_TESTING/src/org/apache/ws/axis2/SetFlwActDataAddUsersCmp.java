 ...
 */
            ...
            /**
            *  SetFlwActDataAddUsersCmp bean class
            */
        
        public  class SetFlwActDataAddUsersCmp
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for AddActPucds
                        * This was an Array!
                        */

                        
                                    protected java.lang.String[] localAddActPucds ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAddActPucdsTracker = false ;
                           ...
                           */
                           public  java.lang.String[] getAddActPucds(){
                               return localAddActPucds;
                           }
                              ...
                              /**
                               * validate the array for AddActPucds
                               */
                              protected void validateAddActPucds(java.lang.String[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param AddActPucds
                              */
                              public void setAddActPucds(java.lang.String[] param){
                              
                                   validateAddActPucds(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localAddActPucdsTracker = true;
                                          } else {
                                             localAddActPucdsTracker = true;
                                                 
                                          }
                                      
                                      this.localAddActPucds=param;
                              }
                             ...
                             */
                             public void addAddActPucds(java.lang.String param){
                                   if (localAddActPucds == null){
                                   localAddActPucds = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localAddActPucds);
                               list.add(param);
                               this.localAddActPucds =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SetFlwActDataAddUsersCmp.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setFlwActDataAddUsersCmp",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setFlwActDataAddUsersCmp",
                ...
                if (localAutInfoTracker){
                                ...
                                } if (localAddActPucdsTracker){
                             if (localAddActPucds!=null) {
                                   namespace = "http://ws.apache.org/axis2";
                                   boolean emptyNamespace = namespace == null || namespace.length() == 0;
                                   prefix =  emptyNamespace ? null : xmlWriter.getPrefix(namespace);
                                   for (int i = 0;i < localAddActPucds.length;i++){
                                        
                                            if (localAddActPucds[i] != null){
                                        
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        java.lang.String prefix2 = generatePrefix(namespace);

                                                        xmlWriter.writeStartElement(prefix2,"addActPucds", namespace);
                                                        xmlWriter.writeNamespace(prefix2, namespace);
                                                        xmlWriter.setPrefix(prefix2, namespace);

                                                    } else {
                                                        xmlWriter.writeStartElement(namespace,"addActPucds");
                                                    }

                                                } else {
                                                    xmlWriter.writeStartElement("addActPucds");
                                                }

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAddActPucds[i]));
                                                           ...
                                                           // write null attribute
                                                            ...
                                                            if (! namespace.equals("")) {
                                                                ...
                                                                if (prefix == null) {
                                                                    ...
                                                                    xmlWriter.writeStartElement(prefix,"addActPucds", namespace);
                                                                    xmlWriter.writeNamespace(prefix, namespace);
                                                                    xmlWriter.setPrefix(prefix, namespace);
                                        ...
                                        // write null attribute
                                            ...
                                            if (! namespace2.equals("")) {
                                                ...
                                                if (prefix2 == null) {
                                                    ...
                                                    xmlWriter.writeStartElement(prefix2,"addActPucds", namespace2);
                                                    xmlWriter.writeNamespace(prefix2, namespace2);
                                                    xmlWriter.setPrefix(prefix2, namespace2);

                                                } else {
                                                    xmlWriter.writeStartElement(namespace2,"addActPucds");
                                                }
                                  ...
                                  for (int i = 0;i < localAddActPucds.length;i++){
                                         ...
                                         if (localAddActPucds[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                                                              "addActPucds"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAddActPucds[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static SetFlwActDataAddUsersCmp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetFlwActDataAddUsersCmp object =
                new SetFlwActDataAddUsersCmp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setFlwActDataAddUsersCmp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetFlwActDataAddUsersCmp)org.apache.ws.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.apache.org/axis2","addActPucds").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone4){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://ws.apache.org/axis2","addActPucds").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setAddActPucds((java.lang.String[])
