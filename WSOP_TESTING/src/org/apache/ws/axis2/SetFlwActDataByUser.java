 ...
 */
            ...
            /**
            *  SetFlwActDataByUser bean class
            */
        
        public  class SetFlwActDataByUser
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localActPucd ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localActPucdTracker = false ;
                           ...
                           */
                           public  java.lang.String getActPucd(){
                               return localActPucd;
                           }
                            ...
                            /**
                               ...
                               * @param param ActPucd
                               */
                               public void setActPucd(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localActPucdTracker = true;
                                       } else {
                                          localActPucdTracker = true;
                                              
                                       }
                                   
                                            this.localActPucd=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SetFlwActDataByUser.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setFlwActDataByUser",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setFlwActDataByUser",
                ...
                if (localAutInfoTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"actPucd", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"actPucd");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("actPucd");
                                    }
                                

                                          if (localActPucd==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localActPucd);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                    ...
                                    localFlwActKey);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                         ...
                                         elementList.add(localActPucd==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localActPucd));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static SetFlwActDataByUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetFlwActDataByUser object =
                new SetFlwActDataByUser();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setFlwActDataByUser".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetFlwActDataByUser)org.apache.ws.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.apache.org/axis2","actPucd").equals(reader.getName())){
