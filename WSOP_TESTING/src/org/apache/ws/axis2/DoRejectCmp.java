 ...
 */
            ...
            /**
            *  DoRejectCmp bean class
            */
        
        public  class DoRejectCmp
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for TargetFlwActKey
                        */

                        
                                    protected struct.xsd.FlwActKey localTargetFlwActKey ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTargetFlwActKeyTracker = false ;
                           ...
                           * @return struct.xsd.FlwActKey
                           */
                           public  struct.xsd.FlwActKey getTargetFlwActKey(){
                               return localTargetFlwActKey;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param TargetFlwActKey
                               */
                               public void setTargetFlwActKey(struct.xsd.FlwActKey param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localTargetFlwActKeyTracker = true;
                                       } else {
                                          localTargetFlwActKeyTracker = true;
                                              
                                       }
                                   
                                            this.localTargetFlwActKey=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DoRejectCmp.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localAutInfoTracker){
                                    ...
                                    if (localFlwActKey==null){
                                     ...
                                     localFlwActKey.serialize(new javax.xml.namespace.QName("http://ws.apache.org/axis2","flwActKey"),
                                        factory,xmlWriter);
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localTargetFlwActKeyTracker){
                                    if (localTargetFlwActKey==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"targetFlwActKey", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"targetFlwActKey");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("targetFlwActKey");
                                        }
                                     ...
                                     localTargetFlwActKey.serialize(new javax.xml.namespace.QName("http://ws.apache.org/axis2","targetFlwActKey"),
                                        factory,xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localAutInfoTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://ws.apache.org/axis2",
                                    ...
                                    elementList.add(localTargetFlwActKey==null?null:
                                    localTargetFlwActKey);
                                }
    ...
    public static class Factory{
        ...
        */
        public static DoRejectCmp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DoRejectCmp object =
                new DoRejectCmp();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"doRejectCmp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DoRejectCmp)org.apache.ws.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.apache.org/axis2","flwActKey").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.apache.org/axis2","comment").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.apache.org/axis2","targetFlwActKey").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setTargetFlwActKey(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setTargetFlwActKey(struct.xsd.FlwActKey.Factory.parse(reader));
